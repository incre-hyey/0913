              ...
              <tr>
                <td bgcolor="#E5E5E5"><table width="100%" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#F2F7F9" align="left"> <input type="text" name="writer" cssStyle="width:100px" theme="simple" value="${vo.writer }"/></td>
                    </tr>

                    <tr>
                      <td height="20" align="center" bgcolor="#669AB3"><font color="#FFFFFF">제목</font></td>
                      <td bgcolor="#F2F7F9" align="left"> <input type="text" name="title" size="50" theme="simple" value="${vo.title }"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#F2F7F9" align="left">
                        ...
                        <%--
                        	...
                        	0보다 클때만 (파일명) 형식으로 출력!
                         --%>
                        <c:if test="${fn:length(vo.uploadFileName) > 0 }">
                        (<span style="color:#0066CC;font-weight: bold">${vo.uploadFileName }</span>)
                        </c:if>
                      </td>
                    </tr>
                    <tr>
